package com.geevegeorge.magniwear;
...
public class MainActivity extends Activity implements SurfaceTextureListener, PreviewCallback {
		...
		Thread previewThred = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					//Rotate the image according to camera orientation calculated earlier in the code
					Matrix m = new Matrix();
